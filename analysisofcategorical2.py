...
## diyleim ki bunu loopa aldık
## tüm datatypelarımız için bunu kullanamıyoruz
## countplot fonksiyonunu yazanlar veri tiplrei için bir genellemede bulunmamıslar.
## bir if koşulu veya exception ile bunu engelleyebiliriz. bool tipleri için geçerlidir.

# önce ilgili değişkeni seçelim
df["adult_male"]
# bool dışındaki bir typea döndürmem lazım
